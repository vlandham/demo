...
/***/ function(module, exports, __webpack_require__) {
	...
	var createGlyphTable = __webpack_require__(26);
	var createDots = __webpack_require__(29);
	var createSquare = __webpack_require__(30);
	var createColorGlyph = __webpack_require__(31);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var fisheye = d3.fisheye.circular().radius(200).distortion(3);
...
/***/ function(module, exports, __webpack_require__) {
	...
	module.exports = function createChart() {
	  ...
	  function click(d, i) {
	    d3.selectAll('.tech').each(function (t) {
	      return t.clicked = false;
	    });
	    d.clicked = true;
	    d3.selectAll('.tech').selectAll('td').style('color', function (e) {
	      return e.clicked ? 'orange' : '#F4F1F1';
	    });
	  }
...
/***/ function(module, exports, __webpack_require__) {
	...
	module.exports = function createChart() {
	  ...
	  var fScale = d3.scale.pow().exponent(0.5).domain([0, 100]).range([30, 6]).clamp(true);
	  ...
	  var chart = function chart(selection) {
	    selection.each(function (rawData) {
	      ...
	      table = d3.select(this).selectAll("table").data([data]);
	      table.enter().append("table").classed('glyphtable', true);
	  ...
	  function update() {
	    ...
	    var techE = techG.enter().append("tr").attr("class", "tech").style('font-size', function (d) {
	      ...
	      return d.glyph;
	    }).style('font-family', 'Courier').style('color', '#F4F1F1').on('click', click).append('span').text(function (d) {
	      return d.remainder;
	    }).style('opacity', 0.0);
	    // .style('background-color', 'steelblue')
	  ...
	  function mousemove() {
	    ...
	    var tS = table.selectAll('.tech').each(function (d, i) {
	      ...
	      return d.font + 'px';
	    }).selectAll('span').style('opacity', function (d) {
	      return d.clicked ? 1.0 : alphaScale(d.dist);
	    });
	    // tS.select('rect')
	    //   .attr('y', (d) => d.y)
...
/***/ function(module, exports, __webpack_require__) {
	...
	module.exports = function createChart() {
	  ...
	  function update() {
	    ...
	    var techE = techG.enter().append('rect').attr('x', function (d) {
	      return xScale(d.name) - 5;
	    }).attr('y', height / 2 - 30).attr('width', 10).attr('height', 60).attr('fill', fill).attr('opacity', '0.0').on('mouseover', mouseover).on('mouseout', mouseout);
	
	    var techE = techG.enter().append('circle').attr('cx', function (d) {
	      return xScale(d.name);
	    }).attr('cy', height / 2).attr('r', 5).attr('fill', '#878787').on('mouseover', mouseover).on('mouseout', mouseout);
	  ...
	  function mouseover(d, i) {
	    ...
	    g.selectAll('circle').attr('fill', function (e, j) {
	      return j === i ? active : fill;
	    });
	
	    g.append('text').classed('textover', true).text(d.name).attr('x', xScale(d.name)).attr('dx', -2).attr('y', height / 2 - 10).attr('fill', 'white').style('font-family', 'Avenir').attr('pointer-events', 'none').style('font-size', '18px');
	  ...
	  function mouseout(d, i) {
	    ...
	    g.selectAll('circle').attr('fill', fill);
	  }
...
/***/ function(module, exports, __webpack_require__) {
	...
	module.exports = function createChart() {
	  ...
	  function update() {
	    ...
	    var techE = techG.enter().append('circle').each(function (d) {
	      d.x = xScale(d.name);
	      d.y = height / 2;
	    }).attr('cx', function (d) {
	      return xScale(d.name);
	  ...
	  function mouseover(d, i) {
	    ...
	    g.append('text').classed('textover', true).text(d.name).attr('x', xScale(d.name) - 30).attr('dx', -2).attr('y', height / 2 - 15).attr('fill', 'white').style('font-family', 'Avenir').attr('pointer-events', 'none').style('font-size', '18px');
	    var t = d3.select('.textover');
	    var bbox = t.node().getBBox();
	    if (bbox.x + bbox.width > width) {
	      t.attr('text-anchor', 'end');
...
/***/ function(module, exports, __webpack_require__) {
	...
	module.exports = function createChart() {
	  ...
	  .range(['#ffa500', '#ff8941', '#f86f53', '#ed5557', '#de3f53', '#cd2a47', '#b81736', '#a2051f', '#8b0000']).range(['#ffa500', '#e28101', '#c55e01', '#a83802', '#8b0000']);
	
	  var colorScale = d3.scale.linear().range(['orange', 'darkred']);
	  ...
	  var chart = function chart(selection) {
	    selection.each(function (rawData) {
	      ...
	      table = d3.select(this).selectAll("table").data([data]);
	      table.enter().append("table").classed('glyphcolortable', true);
	  ...
	  function update() {
	    ...
	    .append('div').classed("box", true).style('width', '6px').style('height', '10px').style('background-color', function (d) {
	      return colorScale(d.count);
	    }).style('margin-right', '5px');
	    // .style('padding-right', '8px')
	    techE.append("td").text(function (d) {
	      return d.glyph;
	    }).style('font-family', 'Courier').style('color', '#F4F1F1').on('click', click).append('span').text(function (d) {
	      return d.remainder;
	    }).style('opacity', 0.0);
	  ...
	  function click(d, i) {
	    ...
	    d3.selectAll('.box').style('opacity', function (e) {
	      return e.clicked ? 1.0 : 0.3;
	    });
	  }
